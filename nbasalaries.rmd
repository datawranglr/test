...
This is an automatically generated notebook for the `nbasalaries` dataset found at:
https://data.world/webmadster/nbasalaries, showcasing the use of the `data.world` R package.
...
dataset_key <- "https://data.world/webmadster/nbasalaries"
